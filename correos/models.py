...
class Thread(models.Model):
    ...
    por el backfill y on-the-fly al asignar correos al thread.
    """
...
class Correo(models.Model):
    ...
    # Headers de threading. Persistidos para agrupar correos por hilo igual
    # que Gmail (no por heurística de asunto).
